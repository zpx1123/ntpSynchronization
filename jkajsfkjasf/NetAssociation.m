...
- (void) queryTimeServer:(NSTimer *) timer {
    ...
    [socket sendData:[self createPacket] toHost:@"17.253.34.253" port:123L withTimeout:2.0 tag:0];
}
...
- (void) evaluatePacket {
    ...
    [self prettyPrintTimers];
    [self prettyPrintPacket];
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    if ((dispersion > 0.1 && dispersion < 50.0) && (stratum > 0) && (mode == 4) &&
        ...
        el_time=ntpDiffSeconds(&ntpClientSendTime, &ntpClientRecvTime);     // .. (T4-T1)//总时间
        st_time=ntpDiffSeconds(&ntpServerRecvTime, &ntpServerSendTime);     // .. (T3-T2)／／服务器等待时间
        
          (el_time-st_time)/2.0;//单成网络时间
...
/*┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
  ...
  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛*/
- (NSDate *)  dateFromNetworkTime:(struct ntpTimestamp *) networkTime {
    NSDate * date=[NSDate dateWithTimeIntervalSince1970:ntpDiffSeconds(&NTP_1970, networkTime)];
    NSLog(@"----------------%@",date);
    return date;
}
...
//                        [self dateFromNetworkTime:&ntpServerBaseTime]];
    ...
    NSString *ntpServerSendTimeStr=[NSString stringWithFormat:@"%u.%.6u",ntpServerRecvTime.fullSeconds,Frac2uSec(ntpServerRecvTime.partSeconds)];
    double ServerSendTimeDou=[ntpServerSendTimeStr doubleValue];
    
    
     NSString *ntpClientRecvTimeStr=[NSString stringWithFormat:@"%u.%.6u",ntpClientRecvTime.fullSeconds,Frac2uSec(ntpClientRecvTime.partSeconds)];
    
     double ClientRecvTimeDou=[ntpClientRecvTimeStr doubleValue];
    
     NSString *ntpClientSendTimeStr=[NSString stringWithFormat:@"%u.%.6u",ntpClientSendTime.fullSeconds,Frac2uSec(ntpClientSendTime.partSeconds)];
    
     double ntpClientSendTimeDou=[ntpClientSendTimeStr doubleValue];
    
     NSString *ntpServerRecvTimeStr=[NSString stringWithFormat:@"%u.%.6u",ntpServerRecvTime.fullSeconds,Frac2uSec(ntpServerRecvTime.partSeconds)];
    
   
     double ntpServerRecvTimeDou=[ntpServerRecvTimeStr doubleValue];
    
    
    
    
    
   double ServerStandard=ServerSendTimeDou+((ClientRecvTimeDou-ntpClientSendTimeDou)-(ServerSendTimeDou-ntpServerRecvTimeDou))/2 -2208988800;
    
    NSDate * date=[NSDate dateWithTimeIntervalSince1970:ServerStandard];
    return prettyString;
